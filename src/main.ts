            ...
            switch (interaction.commandName) {
                ...
                case 'publicshop': {
                    ...
                    for (let i = 0; i < data.namecards.length; i++) {
                        ...
                        context.drawImage(await loadImage(`./build/assets/images/namecards/${namecard.path}`), Math.floor(i / 6) * 1250, (i % 6) * 325, 1200, 300)
                    }
                }
                default: {
                    if (checkModerator(interaction, true)) {
                        switch (interaction.commandName) {
                            ...
                            case 'punish': {
                                ...
                                let i = '1'
                                let guildSettings = data.getGuild(interaction.guildId as string).settings
